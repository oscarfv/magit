...
(defvar magit-menu
  (list
   ...
   '(log opt ?& "--committer=" read-from-minibuffer)
   '(log opt ?! "--all-match" magit-true)
   '(log opt ?> "--since=" read-from-minibuffer)
   '(log opt ?< "--before=" read-from-minibuffer)
   '(log opt ?F "--first-parent" magit-true)
   '(log opt ?N "--name-only" magit-true)
   '(log opt ?M "-M" magit-true)
   '(log opt ?C "-C" magit-true)
   '(log opt ?B "--branches=" read-from-minibuffer)
   '(log opt ?R "--relative=" read-directory-name)
   '(log opt ?S "-S" read-from-minibuffer)
   '(log opt ?X "--pickaxe-regex" magit-true)
   '(log opt ?I "--ignore-submodules" magit-true)
   '(log opt ?G "--merge" magit-true)
